...
<div class="header stiky">
      <header>
        ...
        <div class="navbar-nav">
          <ul>
            <li><a href="/whitehatify/">Home</a></li>
            <li><a formtargrt="_self" href="/whitehatify/#servicehead">Services</a></li>
            <li><a href="/whitehatify/#plans">Plans</a></li>
            <li><a href="/whitehatify/#reqcounseller">Request For Councellor</a></li>';
            if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
            echo '<li><a href="/whitehatify/payment.php">Billing Details</a></li>';
            }
            echo '
